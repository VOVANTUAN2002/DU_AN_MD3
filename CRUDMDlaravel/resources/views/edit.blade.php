            ...
            <div class="col-12">
                <form method="post" action="{{route('customers.update', $customer->id) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="employeecode" placeholder="Enter Mã nhân viên" value="{{$customer->employeecode}}">
                        <span style="color:red;">@error("employeecode"){{ $message }} @enderror</span>
                    </div>
                    <div class="form-group">
