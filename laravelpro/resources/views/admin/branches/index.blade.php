...
<header class="page-title-bar">
    ...
    <div class="d-md-flex align-items-md-start">
        <h1 class="page-title mr-sm-auto"> Chi nhánh</h1><!-- .btn-toolbar -->
        <div class="btn-toolbar">
            <button type="button" class="btn btn-light"><i class="fa-solid fa-file-export"></i> <span
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <div class="dropdown-arrow"></div><a href="#" class="dropdown-item">Add tasks</a> <a href="#"
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#" class="tile tile-img mr-1"><img class="img-fluid"
                                        src="{{asset('assets/images/dummy/img-1.jpg')}}" alt="Card image cap"></a> <a href="#">Tomato
                                    - Green</a>
                            </td>
